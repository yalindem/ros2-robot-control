  ...
  carla_waypoint_types__srv__GetWaypoint_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    carla_waypoint_types__srv__GetWaypoint_Request * data =
      (carla_waypoint_types__srv__GetWaypoint_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!carla_waypoint_types__srv__GetWaypoint_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          carla_waypoint_types__srv__GetWaypoint_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  carla_waypoint_types__srv__GetWaypoint_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    carla_waypoint_types__srv__GetWaypoint_Response * data =
      (carla_waypoint_types__srv__GetWaypoint_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!carla_waypoint_types__srv__GetWaypoint_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          carla_waypoint_types__srv__GetWaypoint_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
