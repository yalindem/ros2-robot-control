  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = carla_waypoint_types__srv__GetWaypoint_Request;
    is_plain =
      (
...
static size_t _GetWaypoint_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_carla_waypoint_types__srv__GetWaypoint_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = carla_waypoint_types__srv__GetWaypoint_Response;
    is_plain =
      (
...
static size_t _GetWaypoint_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_carla_waypoint_types__srv__GetWaypoint_Response(
    full_bounded, is_plain, 0);
