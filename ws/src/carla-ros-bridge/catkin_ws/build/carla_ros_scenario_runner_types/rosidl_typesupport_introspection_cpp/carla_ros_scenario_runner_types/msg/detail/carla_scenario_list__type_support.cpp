...
void fetch_function__CarlaScenarioList__scenarios(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const carla_ros_scenario_runner_types::msg::CarlaScenario *>(
    get_const_function__CarlaScenarioList__scenarios(untyped_member, index));
  auto & value = *reinterpret_cast<carla_ros_scenario_runner_types::msg::CarlaScenario *>(untyped_value);
  value = item;
}

void assign_function__CarlaScenarioList__scenarios(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<carla_ros_scenario_runner_types::msg::CarlaScenario *>(
    get_function__CarlaScenarioList__scenarios(untyped_member, index));
  const auto & value = *reinterpret_cast<const carla_ros_scenario_runner_types::msg::CarlaScenario *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CarlaScenarioList_message_member_array[1] = {
  {
    ...
    fetch_function__CarlaScenarioList__scenarios,  // fetch(index, &value) function pointer
    assign_function__CarlaScenarioList__scenarios,  // assign(index, value) function pointer
