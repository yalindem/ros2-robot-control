  ...
  carla_ros_scenario_runner_types__srv__ExecuteScenario_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    carla_ros_scenario_runner_types__srv__ExecuteScenario_Request * data =
      (carla_ros_scenario_runner_types__srv__ExecuteScenario_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!carla_ros_scenario_runner_types__srv__ExecuteScenario_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          carla_ros_scenario_runner_types__srv__ExecuteScenario_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  carla_ros_scenario_runner_types__srv__ExecuteScenario_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    carla_ros_scenario_runner_types__srv__ExecuteScenario_Response * data =
      (carla_ros_scenario_runner_types__srv__ExecuteScenario_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!carla_ros_scenario_runner_types__srv__ExecuteScenario_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          carla_ros_scenario_runner_types__srv__ExecuteScenario_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
