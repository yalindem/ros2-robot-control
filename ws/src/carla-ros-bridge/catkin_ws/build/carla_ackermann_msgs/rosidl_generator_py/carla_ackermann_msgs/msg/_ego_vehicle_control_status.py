...
class EgoVehicleControlStatus(metaclass=Metaclass_EgoVehicleControlStatus):
    ...
    def speed_control_accel_delta(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'speed_control_accel_delta' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def speed_control_accel_target(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'speed_control_accel_target' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def accel_control_pedal_delta(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'accel_control_pedal_delta' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def accel_control_pedal_target(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'accel_control_pedal_target' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def brake_upper_border(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'brake_upper_border' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def throttle_lower_border(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'throttle_lower_border' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
