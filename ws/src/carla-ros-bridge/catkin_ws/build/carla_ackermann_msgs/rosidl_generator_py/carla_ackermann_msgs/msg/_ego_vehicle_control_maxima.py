...
class EgoVehicleControlMaxima(metaclass=Metaclass_EgoVehicleControlMaxima):
    ...
    def max_accel(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'max_accel' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def max_decel(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'max_decel' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def min_accel(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'min_accel' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
    ...
    def max_pedal(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'max_pedal' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
